...
<body>
  ...
  <div id="wrapper">
    <div id="container_wr">
      ...
      <div id="register_agree">
        <h3>약관 동의</h3>
        <form method="post" action="self.close();" onsubmit="return fregister_submit(this);">
          ...
          <section id="fregister_term">
            ...
            <textarea readonly style="height: 300px; width: 575px;">
  ...
  제24조(재판권 및 준거법)
    ...
    ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
          ...
          <section id="fregister_private">
            ...
            <textarea readonly style="height: 300px; width: 575px;">개인정보처리방침
  ...
  2) 시행일자 : 2018년 05월 01일 
            ...
            <div class="btn_confirm">
              <input type="button" value="닫 기" onclick="closePopup();" />
              <input type="submit" class="btn_submit" value="확 인" id="btn_submit">
            </div>
